...
export const filterData = (data: any[], filterStatus: FilterStatus) => {
  if (filterStatus === "all") return data; // Return all data if filterStatus is "all"
  switch (filterStatus) {
    case "OPEN":
      return data.filter((item) => item.ticket_status === "OPEN");
    case "ANSWERED":
      return data.filter((item) => item.ticket_status === "ANSWERED");
    default:
      return data;
  }
};
...
export const DEFAULT_FILTER_BY_TICKET_STATUS: FilterBy[] = [
  { id: "all", value: "All" }, // Changed "1" to "all" for consistency
  { id: "OPEN", value: "OPEN" },
...
export const DEFAULT_STUDENT_COLUMNS: Column[] = [
  ...
  { id: "center_name", label: "Center", visible: true },
  { id: "user_name", label: "Name", visible: true },
  { id: "attendanceProgress", label: "Attendance Progress", visible: true },
  { id: "std_lms_status", label: "LMS Status", visible: true },
];
export const DEFAULT_STUDENT_COLUMNS_Admin: Column[] = [
  { id: "user_profile_photo", label: "Profile Photo", visible: true },
  { id: "std_rollno", label: "Roll No", visible: true },
  { id: "user_name", label: "Name", visible: true },
  { id: "user_email", label: "Email", visible: true },
  ...
  { id: "center_name", label: "Center", visible: true },
  { id: "attendanceProgress", label: "Attendance Progress", visible: true },
  { id: "std_phone", label: "Phone", visible: true },
  { id: "student_cnic", label: "CNIC", visible: true },
  { id: "std_gender", label: "Gender", visible: true },
  {id: "special_case", label: "Special Case", visible: true },
...
export const DEFUALT_REPORT_COLUMNS: Column[] = [
  ...
  { id: "t_cnic", label: "Trainer Name", visible: true },
...
export const DEFAULT_EARNINGS_SUBMISSIONS_COLUMNS: Column[] = [
  ...
  { id: "studentPhone", label: "Phone", visible: true },
  { id: "gender", label: "Gender", visible: true },
  { id: "trainerName", label: "Trainer Name", visible: true },
  { id: "std_gender", label: "Gender", visible: true },
...
export const DEFAULT_EARNINGS_Totle_COLUMNS: Column[] = [
  { id: "studentImage", label: "File", visible: true },
  { id: "studentName", label: "Student Name", visible: true },
  { id: "platform", label: "Platform", visible: true },
  { id: "totalEarnings", label: "Amount", visible: true },
  { id: "studentPhone", label: "Phone", visible: true },
  { id: "date", label: "Date", visible: true },
  { id: "status", label: "Status", visible: true },
  { id: "centerName", label: "Center", visible: true },
...
export const DEFAULT_EXAM_ASSESSMENT_COLUMNS: Column[] = [
  ...
  { id: "user_name", label: "Student Name", visible: true },
  { id: "std_fathername", label: "Father's Name", visible: true },
  { id: "phoneNumber", label: "Phone Number", visible: true },
  { id: "std_gender", label: "Gender", visible: true },
  { id: "std_earing", label: "Total Earnings", visible: true },
...
export const DEFAULT_LEARNING_RESOURCE_COLUMNS: Column[] = [
  { id: "ls_title", label: "Title", visible: true },
  { id: "ls_description", label: "Description", visible: true },
  { id: "ls_added_on", label: "Added On", visible: true },
  { id: "course_name", label: "Course", visible: true },
  { id: "center_name", label: "Center", visible: true },
  { id: "ls_attachment", label: "Attachment", visible: false },
];

export const DEFAULT_LECTURE_RECORDING_COLUMNS: Column[] = [
  { id: "lr_title", label: "Title", visible: true },
  { id: "lr_topics", label: "Topics", visible: true },
  { id: "lr_date", label: "Date", visible: true },
  { id: "lr_link", label: "Recording Link", visible: true },
  { id: "course_name", label: "Course", visible: true },
  { id: "center_name", label: "Center", visible: true },
  { id: "lr_attachment", label: "Attachment", visible: false },
];
